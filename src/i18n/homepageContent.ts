...
const en = {
  ...
  hero: {
    ...
    visitorsRetry: "Retry visitor count",
    visitorsUnavailable: "Visitor count unavailable",
  ...
  reviews: {
    ...
    body: "Share your experience with NextAura AI and explore feedback from people who have worked with our team.",
    averageRating: "Average rating",
    reviewCount: "Customer reviews: {count}",
    noRatings: "No ratings yet",
    outOfFive: "{rating} out of 5",
    formTitle: "Share your experience",
    formIntro: "Your feedback helps future customers understand what it is like to work with us.",
    nameLabel: "Display name",
    optional: "Optional",
    namePlaceholder: "Your name, company, or leave blank for Anonymous",
    ratingLabel: "Your rating",
    starLabel: "{rating} out of 5 stars",
    ratingSelected: "{rating} of 5 selected",
    ...
    success: "Thank you. Your review is now visible.",
    newest: "Newest reviews",
    anonymous: "Anonymous",
    loadMore: "Load more reviews",
    loadingMore: "Loading reviews…",
    emptyTitle: "Be the first to share an experience",
    emptyBody: "There are no public reviews yet. Your honest feedback can start the conversation.",
    retry: "Try again",
    databaseError:
      "Reviews are temporarily unavailable. The rest of the website is still ready for you.",
    ratingRequired: "Choose a rating from one to five stars.",
    commentRequired: "Write at least 5 characters about your experience.",
    commentTooLong: "Keep your review within {max} characters.",
    submitError: "We could not save your review. Please try again.",
    rateLimited: "You have submitted several reviews recently. Please try again later.",
    duplicate: "This review was already submitted. You can edit the comment before trying again.",
    replies: "Replies ({count})",
    reply: "Reply",
    replyToReview: "Your reply",
    replyNamePlaceholder: "Your name or leave blank for Anonymous",
    replyPlaceholder: "Write a respectful reply…",
    submitReply: "Post reply",
    submittingReply: "Posting reply…",
    cancel: "Cancel",
    replyRequired: "Write at least 2 characters for your reply.",
    replyTooLong: "Keep your reply within {max} characters.",
    replyError: "We could not save your reply. Please try again.",
    replyRateLimited: "You have sent several replies recently. Please try again later.",
    replyDuplicate: "This reply was already sent. Please change it before trying again.",
    inappropriateLanguage: "This language is not allowed. Please keep the conversation respectful.",
  },
  quality: {
...
const ar: Widen<typeof en> = {
  ...
  hero: {
    ...
    visitorsRetry: "إعادة محاولة تحميل عدد الزوار",
    visitorsUnavailable: "عدد الزوار غير متاح حالياً",
  ...
  reviews: {
    ...
    body: "شاركنا تجربتك مع NextAura AI، وتعرّف على آراء من تعاملوا مع فريقنا.",
    averageRating: "متوسط التقييم",
    reviewCount: "مراجعات العملاء: {count}",
    noRatings: "لا توجد تقييمات بعد",
    outOfFive: "{rating} من 5",
    formTitle: "شاركنا تجربتك",
    formIntro: "تساعد ملاحظاتك العملاء القادمين على فهم تجربة العمل معنا.",
    nameLabel: "الاسم الظاهر",
    optional: "اختياري",
    namePlaceholder: "اسمك أو شركتك، أو اترك الحقل فارغاً للظهور كمجهول",
    ratingLabel: "تقييمك",
    starLabel: "{rating} من أصل 5 نجوم",
    ratingSelected: "تم اختيار {rating} من 5",
    commentLabel: "رأيك",
    commentPlaceholder: "أخبرنا عن تجربتك…",
    characterCounter: "{count} / {max} حرفاً",
    submit: "إرسال المراجعة",
    submitting: "جارٍ إرسال المراجعة…",
    success: "شكراً لك. أصبحت مراجعتك ظاهرة الآن.",
    newest: "أحدث المراجعات",
    anonymous: "مجهول",
    loadMore: "عرض المزيد من المراجعات",
    loadingMore: "جارٍ تحميل المراجعات…",
    emptyTitle: "كن أول من يشارك تجربته",
    emptyBody: "لا توجد مراجعات عامة حتى الآن. رأيك الصادق يمكن أن يبدأ الحوار.",
    retry: "إعادة المحاولة",
    databaseError: "المراجعات غير متاحة مؤقتاً، بينما يبقى باقي الموقع جاهزاً للاستخدام.",
    ratingRequired: "اختر تقييماً من نجمة واحدة إلى خمس نجوم.",
    commentRequired: "اكتب 5 أحرف على الأقل عن تجربتك.",
    commentTooLong: "اجعل مراجعتك ضمن {max} حرفاً.",
    submitError: "تعذر حفظ مراجعتك. حاول مرة أخرى.",
    rateLimited: "أرسلت عدة مراجعات مؤخراً. حاول مرة أخرى لاحقاً.",
    duplicate: "تم إرسال هذه المراجعة من قبل. يمكنك تعديل النص ثم المحاولة مجدداً.",
    replies: "الردود ({count})",
    reply: "رد",
    replyToReview: "ردك",
    replyNamePlaceholder: "اسمك أو اتركه فارغاً للظهور كمجهول",
    replyPlaceholder: "اكتب رداً محترماً…",
    submitReply: "نشر الرد",
    submittingReply: "جارٍ نشر الرد…",
    cancel: "إلغاء",
    replyRequired: "اكتب حرفين على الأقل في ردك.",
    replyTooLong: "اجعل ردك ضمن {max} حرفاً.",
    replyError: "تعذر حفظ ردك. حاول مرة أخرى.",
    replyRateLimited: "أرسلت عدة ردود مؤخراً. حاول مرة أخرى لاحقاً.",
    replyDuplicate: "تم إرسال هذا الرد من قبل. غيّره قبل المحاولة مجدداً.",
    inappropriateLanguage: "هذه اللغة غير مسموحة. يرجى إبقاء الحوار محترماً.",
  },
  quality: {
...
const es: Widen<typeof en> = {
  ...
  hero: {
    ...
    visitorsRetry: "Reintentar el conteo de visitantes",
    visitorsUnavailable: "Conteo de visitantes no disponible",
  ...
  reviews: {
    ...
    body: "Comparte tu experiencia con NextAura AI y descubre las opiniones de quienes han trabajado con nuestro equipo.",
    averageRating: "Valoración media",
    reviewCount: "Opiniones de clientes: {count}",
    noRatings: "Todavía no hay valoraciones",
    outOfFive: "{rating} de 5",
    formTitle: "Comparte tu experiencia",
    formIntro: "Tu opinión ayuda a futuros clientes a entender cómo es trabajar con nosotros.",
    nameLabel: "Nombre visible",
    optional: "Opcional",
    namePlaceholder: "Tu nombre, empresa o déjalo vacío para aparecer como Anónimo",
    ratingLabel: "Tu valoración",
    starLabel: "{rating} de 5 estrellas",
    ratingSelected: "{rating} de 5 seleccionado",
    ...
    submitting: "Enviando opinión…",
    success: "Gracias. Tu opinión ya está visible.",
    newest: "Opiniones más recientes",
    anonymous: "Anónimo",
    loadMore: "Cargar más opiniones",
    loadingMore: "Cargando opiniones…",
    emptyTitle: "Sé la primera persona en compartir su experiencia",
    emptyBody:
      "Todavía no hay opiniones públicas. Tu experiencia sincera puede iniciar la conversación.",
    retry: "Intentar de nuevo",
    databaseError:
      "Las opiniones no están disponibles temporalmente. El resto del sitio sigue funcionando.",
    ratingRequired: "Elige una valoración de una a cinco estrellas.",
    commentRequired: "Escribe al menos 5 caracteres sobre tu experiencia.",
    commentTooLong: "Mantén tu opinión dentro de {max} caracteres.",
    submitError: "No pudimos guardar tu opinión. Inténtalo de nuevo.",
    rateLimited: "Has enviado varias opiniones recientemente. Inténtalo más tarde.",
    duplicate:
      "Esta opinión ya se envió. Puedes modificar el comentario antes de intentarlo de nuevo.",
    replies: "Respuestas ({count})",
    reply: "Responder",
    replyToReview: "Tu respuesta",
    replyNamePlaceholder: "Tu nombre o déjalo vacío para aparecer como Anónimo",
    replyPlaceholder: "Escribe una respuesta respetuosa…",
    submitReply: "Publicar respuesta",
    submittingReply: "Publicando respuesta…",
    cancel: "Cancelar",
    replyRequired: "Escribe al menos 2 caracteres para responder.",
    replyTooLong: "Mantén tu respuesta dentro de {max} caracteres.",
    replyError: "No pudimos guardar tu respuesta. Inténtalo de nuevo.",
    replyRateLimited: "Has enviado varias respuestas recientemente. Inténtalo más tarde.",
    replyDuplicate: "Esta respuesta ya se envió. Cámbiala antes de volver a intentarlo.",
    inappropriateLanguage: "Este lenguaje no está permitido. Mantén la conversación respetuosa.",
  },
  quality: {
