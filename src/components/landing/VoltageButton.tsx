...
type VoltageButtonProps = ButtonHTMLAttributes<HTMLButtonElement> & {
  children: ReactNode;
  motionActive?: boolean;
  containerClassName?: string;
};

export const VoltageButton = forwardRef<HTMLDivElement, VoltageButtonProps>(function VoltageButton(
  { children, className, containerClassName = "", motionActive = false, ...buttonProps },
  ref,
) {
  return (
